...
- 🔄 I'm the developer who **relearns their programming language every week** because I reliably forget it
- 📚 Google, docs, and tutorials are my weekly companions
- 🏋️ Currently leveling up two areas of my life: **fitness** 💪 and **knowledge** 🧩
- 🎯 Motto: *"I don't remember how this works — but I've built it before, so I'll build it again."*
...
[■■■■■□□□□□] Collecting knowledge & skills
[■■□□□□□□□□] Making syntax stick permanently (WIP since forever)
```

---

### 🛠️ Tech stack (this week, subject to change)
